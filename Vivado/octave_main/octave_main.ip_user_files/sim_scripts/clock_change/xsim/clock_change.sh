...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot clock_change xil_defaultlib.clock_change -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clock_change -key {Behavioral:sim_1:Functional:clock_change} -tclbatch cmd.tcl -log simulate.log
}
