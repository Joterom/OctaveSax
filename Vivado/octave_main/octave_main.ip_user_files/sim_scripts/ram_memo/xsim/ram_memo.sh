...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot ram_memo xil_defaultlib.ram_memo -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ram_memo -key {Behavioral:sim_1:Functional:ram_memo} -tclbatch cmd.tcl -log simulate.log
}
