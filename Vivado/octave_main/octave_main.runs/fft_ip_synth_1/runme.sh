...
HD_PWD='/home/joterom/workspace/OctaveSax/Vivado/octave_main/octave_main.runs/fft_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_ip.tcl
