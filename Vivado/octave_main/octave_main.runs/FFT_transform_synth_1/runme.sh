...
HD_PWD='D:/UNI/TFG/OctaveSax/Vivado/octave_main/octave_main.runs/FFT_transform_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_transform.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_transform.tcl
