...
HD_PWD='D:/UNI/TFG/OctaveSax/Vivado/octave_main/octave_main.runs/freq_memo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log freq_memo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source freq_memo.tcl
