...
HD_PWD='D:/UNI/TFG/octave_main/octave_main.runs/fft_module_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_module.tcl
