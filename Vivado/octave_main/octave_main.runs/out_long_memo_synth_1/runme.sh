...
HD_PWD='/home/joterom/workspace/OctaveSax/Vivado/octave_main/octave_main.runs/out_long_memo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log out_long_memo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source out_long_memo.tcl
