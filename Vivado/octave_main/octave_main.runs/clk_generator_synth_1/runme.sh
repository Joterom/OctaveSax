...
HD_PWD='/home/joterom/workspace/OctaveSax/Vivado/octave_main/octave_main.runs/clk_generator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_generator.tcl
