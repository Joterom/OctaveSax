...
HD_PWD='/home/joterom/workspace/OctaveSax/Vivado/octave_main/octave_main.runs/ram_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_memory.tcl
