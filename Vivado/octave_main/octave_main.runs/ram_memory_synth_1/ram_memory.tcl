...
synth_design -top ram_memory -part xc7a100tcsg324-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix ram_memory_ ram_memory.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ram_memory_stub.v
 lappend ipCachedFiles ram_memory_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ram_memory_stub.vhdl
 lappend ipCachedFiles ram_memory_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ram_memory_sim_netlist.v
 lappend ipCachedFiles ram_memory_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ram_memory_sim_netlist.vhdl
 lappend ipCachedFiles ram_memory_sim_netlist.vhdl

 config_ip_cache -add -dcp ram_memory.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips ram_memory]
}

rename_ref -prefix_all ram_memory_
