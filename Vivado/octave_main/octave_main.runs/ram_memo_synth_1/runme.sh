...
HD_PWD='D:/UNI/TFG/OctaveSax/Vivado/octave_main/octave_main.runs/ram_memo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_memo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_memo.tcl
