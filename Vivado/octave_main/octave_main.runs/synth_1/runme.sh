...
HD_PWD='D:/UNI/TFG/OctaveSax/Vivado/octave_main/octave_main.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sampling.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sampling.tcl
