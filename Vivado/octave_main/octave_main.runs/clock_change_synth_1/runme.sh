...
HD_PWD='/home/joterom/workspace/OctaveSax/Vivado/octave_main/octave_main.runs/clock_change_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_change.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_change.tcl
