    ...
    process(clk_100MHz, reset)
        begin            
            if reset = '1' then           
                ...
                address_buf1 <= "00001000000000";
                address_buf2 <= (others => '0');
                address_buf3 <= "00001000000000";
                start_buffer1 <= '0';
                start_buffer3 <= '0';
                start_buffer2 <= '0';
                -- Reading
                ...
                address_buf1r <= "00001000000000";
                address_buf2r <= (others => '0');
                address_buf3r <= "00001000000000";
                start_buffer1r <= '0';
                start_buffer3r <= '0';
                start_buffer2r <= '0';
                read_sample_memo <= '0';
        ...
        begin
            ...
            if event_new_frame = '1' then
                if start_reading = '1' then
                    ...
                    if address_buf0r = "00000111111111" then
                    ...
                    if start_buffer1r = '1' then
                        ...
                        if start_buffer2r = '1' then
                            ...
                            if start_buffer3r = '1' then
                                ...
                                if address_buf3r = "00001111111111" then
                                    address_buf3r_next <= "00001000000000";
                                else
                ...
                if address_buf0 = "00000111111111" then
                ...
                if start_buffer1 = '1' then
                    ...
                    if address_buf1 = "00001111111111" then
                        address_buf1_next <= "00001000000000";
                    else
                        address_buf1_next <= std_logic_vector(unsigned(address_buf1) + 1);
                    end if;
                    if start_buffer2 = '1' then
                        counter_buf2_next <= counter_buf2 + 1;
                        if address_buf2 = "00000111111111" then
                        ...
                        if start_buffer3 = '1' then
                            ...
                            if address_buf3 = "00001111111111" then
                                address_buf3_next <= "00001000000000";
                            else
