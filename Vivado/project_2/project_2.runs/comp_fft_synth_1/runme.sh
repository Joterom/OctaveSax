...
HD_PWD='/home/joterom/workspace/OctaveSax/Vivado/prueba_FFT/prueba_FFT.runs/comp_fft_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_fft.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp_fft.tcl
